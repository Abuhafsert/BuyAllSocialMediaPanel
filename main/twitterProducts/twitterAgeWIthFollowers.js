import { age1000, age2000, age3000, age4000, age5000 } from "./newFormats/ageWithFollowers.js";
import { sleep, dayTime } from "../AllSocialPanel/dayTime.js";
import { 
    YearTwitterPriceWithFollowers1000,
    YearTwitterPriceWithFollowers2000,
    YearTwitterPriceWithFollowers3000,
    YearTwitterPriceWithFollowers4000,
    YearTwitterPriceWithFollowers5000
...
const ageTwitterProductWithFollowers = (uid, get, child, stt, update, ref, database)=>{
    btns.forEach(btn => {
        ...
        if(btnValue === 1){
            pricePerAccount = YearTwitterPriceWithFollowers1000
            prices[0].innerHTML = pricePerAccount * amount[0].value
            onInput(pricePerAccount, btnValue)
            }else if(btnValue === 2){
                pricePerAccount = YearTwitterPriceWithFollowers2000
                prices[1].innerHTML = pricePerAccount * amount[1].value
                onInput(pricePerAccount, btnValue)
                
            }else if(btnValue === 3){
                pricePerAccount = YearTwitterPriceWithFollowers3000
                prices[2].innerHTML = pricePerAccount * amount[2].value
                onInput(pricePerAccount, btnValue)
                
                
            }else if(btnValue === 4){
                pricePerAccount = YearTwitterPriceWithFollowers4000
                prices[3].innerHTML = pricePerAccount * amount[3].value
                
                onInput(pricePerAccount, btnValue)
            }else if(btnValue === 5){
                pricePerAccount = YearTwitterPriceWithFollowers5000
...
async function ageTwitterWithFollowers(get, child, stt){
    let array = []
...
export { ageTwitterWithFollowers, ageTwitterProductWithFollowers }
...
export function ageProduct(uid, get, child, stt, update, ref, database, nextSibling, input, btnValue){
    let idNo = null;
    if(btnValue === 1){
        age1000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, YearTwitterPriceWithFollowers1000)
    } else if(btnValue === 2){
        age2000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, YearTwitterPriceWithFollowers2000)
    }else if(btnValue === 3){           
        age3000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, YearTwitterPriceWithFollowers3000)
    }else if(btnValue === 4){            
        age4000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, YearTwitterPriceWithFollowers4000)
    }else if(btnValue === 5){
        age5000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, YearTwitterPriceWithFollowers5000)
    // }else if(btnValue === 6){        
