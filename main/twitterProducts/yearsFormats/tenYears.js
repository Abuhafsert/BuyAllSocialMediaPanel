...
const tenYear = async (uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, da, fileLocation, price)=>{
              ...
              await get(child(stt, 'ageTwitterAccounts/' + 2014)).then( async (snapshot) => {
                ...
                if(snapshot.exists()) {
                  ...
                  if(input > usd.length){
                    ...
                    await update(ref(database, 'ageTwitterAccounts/' + 2014 + '/'),{
                        tenYear: usd
