import { monthly1000, monthly2000, monthly3000, monthly4000, monthly5000 } from "./newFormats/monthlyWithFollowers.js"
import { sleep, dayTime } from "../AllSocialPanel/dayTime.js"
import { 
    monthlyTwitterPriceWithFollowers100,
    monthlyTwitterPriceWithFollowers200,
    monthlyTwitterPriceWithFollowers300,
    monthlyTwitterPriceWithFollowers400,
    monthlyTwitterPriceWithFollowers500
...
const monthlyTwitterProductWithFollowers = (uid, get, child, stt, update, ref, database)=>{
    btns.forEach(btn => {
        ...
        if(btnValue === 1){
            pricePerAccount = monthlyTwitterPriceWithFollowers100
            prices[0].innerHTML = pricePerAccount * amount[0].value
            onInput(pricePerAccount, btnValue)
            }else if(btnValue === 2){
                pricePerAccount = monthlyTwitterPriceWithFollowers200
                prices[1].innerHTML = pricePerAccount * amount[1].value
                onInput(pricePerAccount, btnValue)
                
            }else if(btnValue === 3){
                pricePerAccount = monthlyTwitterPriceWithFollowers300
                prices[2].innerHTML = pricePerAccount * amount[2].value
                onInput(pricePerAccount, btnValue)
                
                
            }else if(btnValue === 4){
                pricePerAccount = monthlyTwitterPriceWithFollowers400
                prices[3].innerHTML = pricePerAccount * amount[3].value
                
                onInput(pricePerAccount, btnValue)
            }else if(btnValue === 5){
                pricePerAccount = monthlyTwitterPriceWithFollowers500
...
async function monthlyTwitterWithFollowers(get, child, stt){
    let array = []
    ...
    // await get(child(stt, 'products/' + 2018)).then( async (snapshot) => {
    //     if(snapshot.exists()) {         
    ...
    // })
    // await get(child(stt, 'ageAccountsWithPost/' + 2017)).then( async (snapshot) => {
    //     if(snapshot.exists()) {         
    ...
    // })
    // await get(child(stt, 'ageAccountsWithPost/' + 2016)).then( async (snapshot) => {
    //     if(snapshot.exists()) {         
    ...
    // })
    // await get(child(stt, 'ageAccountsWithPost/' + 2015)).then( async (snapshot) => {
    //     if(snapshot.exists()) {         
    ...
    // })
    // await get(child(stt, 'ageAccountsWithPost/' + 2014)).then( async (snapshot) => {
    //     if(snapshot.exists()) {         
...
export { monthlyTwitterProductWithFollowers, monthlyTwitterWithFollowers }
...
export function ageProduct(uid, get, child, stt, update, ref, database, nextSibling, input, btnValue){
    let idNo = null;
    if(btnValue === 1){
        monthly1000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, monthlyTwitterPriceWithFollowers100)
    } else if(btnValue === 2){
        monthly2000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, monthlyTwitterPriceWithFollowers200)
    }else if(btnValue === 3){           
        monthly3000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, monthlyTwitterPriceWithFollowers300)
    }else if(btnValue === 4){            
        monthly4000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, monthlyTwitterPriceWithFollowers400)
    }else if(btnValue === 5){
        monthly5000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, monthlyTwitterPriceWithFollowers500)
    // }else if(btnValue === 6){        
