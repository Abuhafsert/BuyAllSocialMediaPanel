...
const monthlyFacebook = async (uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, da, fileLocation, price)=>{
            ...
            get(child(stt, 'users/' + uid)).then(async (snapshot) => {
              ...
              get(child(stt, 'monthlyFacebook/')).then( async (snapshot) => {
                ...
                if(snapshot.exists()) {
                  ...
                  await update(ref(database, 'monthlyFacebook/'),{
                    new: usd
