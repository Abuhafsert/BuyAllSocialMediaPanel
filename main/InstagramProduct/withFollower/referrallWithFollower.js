import { referral100, referral200, referral300, referral400, referral500 } from "./withFollowers/referalWithFollowers.js";
import { sleep, dayTime } from "../../AllSocialPanel/dayTime.js";
import { 
    referralProductWithFollowers100,
    referralProductWithFollowers200,
    referralProductWithFollowers300,
    referralProductWithFollowers400,
    referralProductWithFollowers500
...
const referralProductWithFollowers = (uid, get, child, stt, update, ref, database)=>{
    btns.forEach(btn => {
        ...
        if(btnValue === 1){
            pricePerAccount = referralProductWithFollowers100
            prices[0].innerHTML = pricePerAccount * amount[0].value
            onInput(pricePerAccount, btnValue)
            }else if(btnValue === 2){
                pricePerAccount = referralProductWithFollowers200
                prices[1].innerHTML = pricePerAccount * amount[1].value
                onInput(pricePerAccount, btnValue)
                
            }else if(btnValue === 3){
                pricePerAccount = referralProductWithFollowers300
                prices[2].innerHTML = pricePerAccount * amount[2].value
                onInput(pricePerAccount, btnValue)
                
                
            }else if(btnValue === 4){
                pricePerAccount = referralProductWithFollowers400
                prices[3].innerHTML = pricePerAccount * amount[3].value
                
                onInput(pricePerAccount, btnValue)
            }else if(btnValue === 5){
                pricePerAccount = referralProductWithFollowers500
...
function referralinstaWithFollowers(get, child, stt){
    let array = []
...
export { referralProductWithFollowers, referralinstaWithFollowers }
...
export function ageProduct(uid, get, child, stt, update, ref, database, nextSibling, input, btnValue){
    let idNo = null;
    if(btnValue === 1){
        referral100(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, referralProductWithFollowers100)
    } else if(btnValue === 2){
        referral200(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, referralProductWithFollowers200)
    }else if(btnValue === 3){           
        referral300(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, referralProductWithFollowers300)
    }else if(btnValue === 4){            
        referral400(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, referralProductWithFollowers400)
    }else if(btnValue === 5){
        referral500(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, referralProductWithFollowers500)
    // }else if(btnValue === 6){        
