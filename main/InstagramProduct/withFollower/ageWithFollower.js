import { age1000, age2000, age3000, age4000, age5000 } from "./withFollowers/ageWithFollowers.js";
import { sleep, dayTime } from "../../AllSocialPanel/dayTime.js";
import { 
 ageProductWithFollowers1000,
 ageProductWithFollowers2000,
 ageProductWithFollowers3000,
 ageProductWithFollowers4000,
 ageProductWithFollowers5000
...
const ageProductWithFollowers = (uid, get, child, stt, update, ref, database)=>{
    btns.forEach(btn => {
...
function ageinstaWithFollowers(get, child, stt){
    let array = []
...
export { ageProductWithFollowers, ageinstaWithFollowers }
...
export function ageProduct(uid, get, child, stt, update, ref, database, nextSibling, input, btnValue){
    let idNo = null;
    if(btnValue === 1){
        age1000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, ageProductWithFollowers1000)
    } else if(btnValue === 2){
        age2000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, ageProductWithFollowers2000)
    }else if(btnValue === 3){           
        age3000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, ageProductWithFollowers3000)
    }else if(btnValue === 4){            
        age4000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, ageProductWithFollowers4000)
    }else if(btnValue === 5){
        age5000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, ageProductWithFollowers5000)
    // }else if(btnValue === 6){        
