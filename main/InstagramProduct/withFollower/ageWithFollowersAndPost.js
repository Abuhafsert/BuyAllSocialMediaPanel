import { ageWithPost1000, ageWithPost2000, ageWithPost3000, ageWithPost4000, ageWithPost5000 } from "./withFollowers/ageWithFollowersAndPosts.js";
import { sleep, dayTime } from "../../AllSocialPanel/dayTime.js";
import { 
ageProductWithFollowersAndPost1000,
ageProductWithFollowersAndPost2000,
ageProductWithFollowersAndPost3000,
ageProductWithFollowersAndPost4000,
ageProductWithFollowersAndPost5000
...
const ageProductWithFollowersAndPost = (uid, get, child, stt, update, ref, database)=>{
    btns.forEach(btn => {
        ...
        if(btnValue === 1){
            pricePerAccount = ageProductWithFollowersAndPost1000
            prices[0].innerHTML = pricePerAccount * amount[0].value
            onInput(pricePerAccount, btnValue)
            }else if(btnValue === 2){
                pricePerAccount = ageProductWithFollowersAndPost2000
                prices[1].innerHTML = pricePerAccount * amount[1].value
                onInput(pricePerAccount, btnValue)
                
            }else if(btnValue === 3){
                pricePerAccount = ageProductWithFollowersAndPost3000
                prices[2].innerHTML = pricePerAccount * amount[2].value
                onInput(pricePerAccount, btnValue)
                
                
            }else if(btnValue === 4){
                pricePerAccount = ageProductWithFollowersAndPost4000
                prices[3].innerHTML = pricePerAccount * amount[3].value
                
                onInput(pricePerAccount, btnValue)
            }else if(btnValue === 5){
                pricePerAccount = ageProductWithFollowersAndPost5000
...
function ageinstaWithFollowersAndPost(get, child, stt){
    let array = []
...
export { ageProductWithFollowersAndPost, ageinstaWithFollowersAndPost }
...
export function ageProduct(uid, get, child, stt, update, ref, database, nextSibling, input, btnValue){
    let idNo = null;
    if(btnValue === 1){
        ageWithPost1000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, ageProductWithFollowersAndPost1000)
    } else if(btnValue === 2){
        ageWithPost2000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, ageProductWithFollowersAndPost2000)
    }else if(btnValue === 3){           
        ageWithPost3000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, ageProductWithFollowersAndPost3000)
    }else if(btnValue === 4){            
        ageWithPost4000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, ageProductWithFollowersAndPost4000)
    }else if(btnValue === 5){
        ageWithPost5000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, ageProductWithFollowersAndPost5000)
    // }else if(btnValue === 6){        
