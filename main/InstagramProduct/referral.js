...
function referralProduct(uid, get, child, stt, update, ref, database){
...
function kloop(get, child, stt){
    let array = []
    
    get(child(stt, 'products/')).then( async (snapshot) => {
        if(snapshot.exists()) {         
