import { monthly1000, monthly2000, monthly3000, monthly4000, monthly5000 } from "./ageFollowers/tiktokWithFollowers.js";
import { sleep, dayTime } from "../AllSocialPanel/dayTime.js";
import { 
    monthlTiktokyProductWithFollowers1000,
    monthlyTiktokProductWithFollowers2000,
    monthlyTiktokProductWithFollowers3000,
    monthlyTiktokProductWithFollowers4000,
    monthlyTiktokProductWithFollowers5000
 } from "../pricesAccounts/tiktokPrice.js";
...
const monthlyTiktokProductWithFollowers = (uid, get, child, stt, update, ref, database)=>{
    btns.forEach(btn => {
        ...
        if(btnValue === 1){
            pricePerAccount = monthlTiktokyProductWithFollowers1000
            prices[0].innerHTML = pricePerAccount * amount[0].value
            onInput(pricePerAccount, btnValue)
            }else if(btnValue === 2){
                pricePerAccount = monthlyTiktokProductWithFollowers2000
                prices[1].innerHTML = pricePerAccount * amount[1].value
                onInput(pricePerAccount, btnValue)
                
            }else if(btnValue === 3){
                pricePerAccount = monthlyTiktokProductWithFollowers3000
                prices[2].innerHTML = pricePerAccount * amount[2].value
                onInput(pricePerAccount, btnValue)
                
                
            }else if(btnValue === 4){
                pricePerAccount = monthlyTiktokProductWithFollowers4000
                prices[3].innerHTML = pricePerAccount * amount[3].value
                
                onInput(pricePerAccount, btnValue)
            }else if(btnValue === 5){
                pricePerAccount = monthlyTiktokProductWithFollowers5000
...
function monthlyTiktokWithFollowers(get, child, stt){
    let array = []
    
    get(child(stt, 'mothlytiktokwithfollowers/' + 1000)).then( async (snapshot) => {
        if(snapshot.exists()) {         
    ...
    get(child(stt, 'mothlytiktokwithfollowers/' + 2000)).then( async (snapshot) => {
        if(snapshot.exists()) {         
    ...
    get(child(stt, 'mothlytiktokwithfollowers/' + 3000)).then( async (snapshot) => {
        if(snapshot.exists()) {         
    ...
    get(child(stt, 'mothlytiktokwithfollowers/' + 4000)).then( async (snapshot) => {
        if(snapshot.exists()) {         
    ...
    get(child(stt, 'mothlytiktokwithfollowers/' + 5000)).then( async (snapshot) => {
        if(snapshot.exists()) {         
...
export { monthlyTiktokProductWithFollowers, monthlyTiktokWithFollowers }
...
export function ageProduct(uid, get, child, stt, update, ref, database, nextSibling, input, btnValue){
    let idNo = null;
    if(btnValue === 1){
        monthly1000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, monthlTiktokyProductWithFollowers1000)
    } else if(btnValue === 2){
        monthly2000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, monthlyTiktokProductWithFollowers2000)
    }else if(btnValue === 3){           
        monthly3000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, monthlyTiktokProductWithFollowers3000)
    }else if(btnValue === 4){            
        monthly4000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, monthlyTiktokProductWithFollowers4000)
    }else if(btnValue === 5){
        monthly5000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, monthlyTiktokProductWithFollowers5000)
    // }else if(btnValue === 6){        
