import { balance } from "../monthly.js"
            ...
            get(child(stt, 'users/' + uid)).then(async (snapshot) => {
              ...
              get(child(stt, 'mothlytiktokwithfollowers/' + 1000 )).then( async (snapshot) => {
                ...
                if(snapshot.exists()) {
                  ...
                  await update(ref(database, 'mothlytiktokwithfollowers/' + 1000 + '/'),{
                    monthly: usd
                  ...
                  for(let l of selectt){
                      ...
                      <td>${email}</td>
                      <td>${emailPassword}</td>
                      <td>Monthly Tiktok With 1000+ Followers</td>
                      <td>${price}</td>
                      <td>${da}</td>
                  </tr>`
          ...
          if(parseFloat(nextSibling) > Number(userBalances)){
            ...
            get(child(stt, 'users/' + uid)).then(async (snapshot) => {
              ...
              get(child(stt, 'mothlytiktokwithfollowers/' + 2000)).then( async (snapshot) => {
                ...
                await update(ref(database, 'mothlytiktokwithfollowers/' + 2000 + '/'),{
                  monthly: usd
                  ...
                  for(let l of selectt){
                      ...
                      <td>${email}</td>
                      <td>${emailPassword}</td>
                      <td>Monthly Tiktok With 2000+ Followers</td>
                      <td>${price}</td>
                      <td>${da}</td>
                  </tr>`
          ...
          if(parseFloat(nextSibling) > Number(userBalances)){
            ...
            get(child(stt, 'users/' + uid)).then(async (snapshot) => {
              ...
              get(child(stt, 'mothlytiktokwithfollowers/' + 3000)).then( async (snapshot) => {
                ...
                await update(ref(database, 'mothlytiktokwithfollowers/' + 3000 + '/'),{
                  monthly: usd
                  ...
                  for(let l of selectt){
                      ...
                      <td>${email}</td>
                      <td>${emailPassword}</td>
                      <td>Monthly Tiktok With 3000+ Followers</td>
                      <td>${price}</td>
                      <td>${da}</td>
                  </tr>`
          ...
          if(parseFloat(nextSibling) > Number(userBalances)){
            ...
            get(child(stt, 'users/' + uid)).then(async (snapshot) => {
              ...
              get(child(stt, 'mothlytiktokwithfollowers/' + 4000)).then( async (snapshot) => {
                ...
                await update(ref(database, 'mothlytiktokwithfollowers/' + 4000 + '/'),{
                  monthly: usd
                  ...
                  for(let l of selectt){
                      ...
                      <td>${email}</td>
                      <td>${emailPassword}</td>
                      <td>Monthly Tiktok With 4000+ Followers</td>
                      <td>${price}</td>
                      <td>${da}</td>
                  </tr>`
          ...
          if(parseFloat(nextSibling) > Number(userBalances)){
            ...
            get(child(stt, 'users/' + uid)).then(async (snapshot) => {
              ...
              get(child(stt, 'mothlytiktokwithfollowers/' + 5000)).then( async (snapshot) => {
                ...
                await update(ref(database, 'mothlytiktokwithfollowers/' + 5000 + '/'),{
                  monthly: usd
                  ...
                  for(let l of selectt){
                      ...
                      <td>${email}</td>
                      <td>${emailPassword}</td>
                      <td>Monthly Tiktok With 5000+ Followers</td>
                      <td>${price}</td>
                      <td>${da}</td>
                  </tr>`
