import { ageTiktok1000, ageTiktok2000, ageTiktok3000, ageTiktok4000, ageTiktok5000 } from "./ageFollowers/ageTiktokWithFollowers.js";
import { sleep, dayTime } from "../AllSocialPanel/dayTime.js";
import { 
 ageTiktokProductWithFollowers1000,
 ageTiktokProductWithFollowers2000,
 ageTiktokProductWithFollowers3000,
 ageTiktokProductWithFollowers4000,
 ageTiktokProductWithFollowers5000
...
const ageTiktokProductWithFollowers = (uid, get, child, stt, update, ref, database)=>{
    btns.forEach(btn => {
        ...
        if(btnValue === 1){
            pricePerAccount = ageTiktokProductWithFollowers1000
            prices[0].innerHTML = pricePerAccount * amount[0].value
            onInput(pricePerAccount, btnValue)
            }else if(btnValue === 2){
                pricePerAccount = ageTiktokProductWithFollowers2000
                prices[1].innerHTML = pricePerAccount * amount[1].value
                onInput(pricePerAccount, btnValue)
                
            }else if(btnValue === 3){
                pricePerAccount = ageTiktokProductWithFollowers3000
                prices[2].innerHTML = pricePerAccount * amount[2].value
                onInput(pricePerAccount, btnValue)
                
                
            }else if(btnValue === 4){
                pricePerAccount = ageTiktokProductWithFollowers4000
                prices[3].innerHTML = pricePerAccount * amount[3].value
                
                onInput(pricePerAccount, btnValue)
            }else if(btnValue === 5){
                pricePerAccount = ageTiktokProductWithFollowers5000
...
function ageTiktokWithFollowers(get, child, stt){
    let array = []
    
    get(child(stt, 'agetiktokwithfollower/' + 1000)).then( async (snapshot) => {
        if(snapshot.exists()) {         
    ...
    get(child(stt, 'agetiktokwithfollower/' + 2000)).then( async (snapshot) => {
        if(snapshot.exists()) {         
    ...
    get(child(stt, 'agetiktokwithfollower/' + 3000)).then( async (snapshot) => {
        if(snapshot.exists()) {         
    ...
    get(child(stt, 'agetiktokwithfollower/' + 4000)).then( async (snapshot) => {
        if(snapshot.exists()) {         
    ...
    get(child(stt, 'agetiktokwithfollower/' + 5000)).then( async (snapshot) => {
        if(snapshot.exists()) {         
...
export { ageTiktokProductWithFollowers, ageTiktokWithFollowers }
...
export function ageProduct(uid, get, child, stt, update, ref, database, nextSibling, input, btnValue){
    let idNo = null;
    if(btnValue === 1){
        ageTiktok1000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, ageTiktokProductWithFollowers1000)
    } else if(btnValue === 2){
        ageTiktok2000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime, location, ageTiktokProductWithFollowers2000)
    }else if(btnValue === 3){           
        ageTiktok3000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, ageTiktokProductWithFollowers3000)
    }else if(btnValue === 4){            
        ageTiktok4000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, ageTiktokProductWithFollowers4000)
    }else if(btnValue === 5){
        ageTiktok5000(uid, get, child, stt, update, ref, database, nextSibling, input, idNo, current, dayTime,location, ageTiktokProductWithFollowers5000)
    // }else if(btnValue === 6){        
